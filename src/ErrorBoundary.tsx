      ...
      return (
        ...
        >
          <div className="max-w-2xl w-full bg-white border-2 border-black p-12 shadow-2xl">
            <h1 className="text-6xl font-black uppercase tracking-tighter font-serif mb-6">
              Design <br /> <span className="text-accent italic">Interrupted.</span>
            </h1>
            <p className="text-slate-600 font-serif text-lg mb-8 leading-relaxed">
              Something unexpected occurred while rendering the editorial layout. We apologize for
              the disruption.
            </p>
            {this.state.error && (
